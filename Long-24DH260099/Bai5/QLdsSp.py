...
def luu_vao_file_txt(ds_san_pham, ten_file="data_san_pham.txt"):
    with open(ten_file, 'w', encoding='utf-8') as file:1
        for sp in ds_san_pham:
            file.write(f"{sp['maSP']},{sp['tenSP']},{sp['gia']}\n")
